...
const RecommendationList = () => {
    ...
    const { table: { vesselRecommendation = {} } = {} } = useSelector(state => state[STATE_REDUCER_KEY]);
    const { data: recommendationList = [], requestInProgress: loading = false } = vesselRecommendation;
